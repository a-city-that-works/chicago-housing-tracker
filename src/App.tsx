...
import { AffordableUnits } from "./pages/AffordableUnits";
...
const BUILT = new Set(["affordability", "permitting", "affordable", "income"]);
    ...
    <BrowserRouter>
      <Routes>
        <Route element={<SiteLayout />}>
          ...
          <Route path="affordable" element={<AffordableUnits />} />
